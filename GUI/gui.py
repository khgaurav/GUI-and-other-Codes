...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chgEnd = QtWidgets.QPushButton(self.layoutWidget)
        self.chgEnd.setObjectName("chgEnd")
        self.verticalLayout.addWidget(self.chgEnd)
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(370, 80, 67, 17))
        self.label.setObjectName("label")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(0, 5, 356, 128))
        ...
        self.Latitude_7 = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Latitude_7.setFont(font)
        self.Latitude_7.setText("")
        self.Latitude_7.setObjectName("Latitude_7")
        self.gridLayout.addWidget(self.Latitude_7, 3, 0, 1, 1)
        self.Longitude_7 = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Longitude_7.setFont(font)
        self.Longitude_7.setText("")
        self.Longitude_7.setObjectName("Longitude_7")
        self.gridLayout.addWidget(self.Longitude_7, 3, 1, 1, 1)
        self.Latitude_8 = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Latitude_8.setFont(font)
        self.Latitude_8.setText("")
        self.Latitude_8.setObjectName("Latitude_8")
        self.gridLayout.addWidget(self.Latitude_8, 3, 2, 1, 1)
        self.Longitude_8 = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.Longitude_8.setFont(font)
        self.Longitude_8.setText("")
        self.Longitude_8.setObjectName("Longitude_8")
        self.gridLayout.addWidget(self.Longitude_8, 3, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Latitude_7.setPlaceholderText(_translate("MainWindow", "Latitude"))
        self.Longitude_7.setPlaceholderText(_translate("MainWindow", "Longitude"))
        self.Latitude_8.setPlaceholderText(_translate("MainWindow", "Latitude"))
        self.Longitude_8.setPlaceholderText(_translate("MainWindow", "Longitude"))
